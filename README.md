...
I would definitely like to add more features based on feedback. Since I have only been using it for personal purposes, I have not added in turntable support, more comprehensive automated test scenarios, and/or complex history/report generation yet ;)
